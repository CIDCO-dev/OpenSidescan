...
call "%qt_compiler_dir%\bin\qmake.exe" ..\OpenSidescan.pro -spec win32-msvc "CONFIG+=qtquickcompiler" && "%qt_compiler_dir%\..\..\Tools\QtCreator\bin\jom.exe"  -f Makefile.Release
