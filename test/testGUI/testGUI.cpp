...

{
    ...
    QWidget * modalWidget = QApplication::activeModalWidget(); //A modal widget must be closed before the user can continue with other parts of the program.
	...
	std::cout << "END ! of interactWithModalWindowActionImport()" << std::endl;
